...
실행하고 Gradle wrapper·계약 drift·Docker image build/non-root/health smoke를 함께 검사합니다.
CI에는 운영 Secret을 주입하거나 실제 AI·지도·DB를 호출하지 않으며 image를 registry에
push하거나 배포하지 않습니다.
