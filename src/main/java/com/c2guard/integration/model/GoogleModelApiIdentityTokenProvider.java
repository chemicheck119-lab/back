...
final class GoogleModelApiIdentityTokenProvider implements ModelApiIdentityTokenProvider {

    private final URI audience;
    private final IdTokenCredentials credentials;

    GoogleModelApiIdentityTokenProvider(String audience) throws IOException {
        if (audience == null || audience.isBlank()) {
            throw new IllegalArgumentException("Model API IAM audience must not be blank");
        }
